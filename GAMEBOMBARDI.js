...
var audioCAN = new Audio('sounds/CANON.mp3');
...
var audioWINFOOD = new Audio('sounds/WINFOOD.mp3');
//var audioWINBOMB = new Audio('sounds/WINBOMB.mp3');
...
function STAGE1(){  STAGE=1;audioBOUTTON.play();document.getElementById("playerPONG").style.opacity=1;}
